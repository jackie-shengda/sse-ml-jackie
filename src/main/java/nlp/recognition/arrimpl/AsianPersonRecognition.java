package nlp.recognition.arrimpl;

import java.util.ArrayList;
import java.util.List;

import nlp.domain.Nature;
import nlp.domain.NewWord;
import nlp.domain.PersonNatureAttr;
import nlp.domain.Term;
import nlp.domain.TermNatures;
import nlp.library.NgramLibrary;
import nlp.recognition.TermArrRecognition;
import nlp.util.TermUtil;
import nlp.util.TermUtil.InsertTermType;
