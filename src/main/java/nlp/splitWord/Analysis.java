package nlp.splitWord;

import static nlp.library.DATDictionary.status;
...
import nlp.domain.TermNature;
import nlp.domain.TermNatures;
import nlp.library.AmbiguityLibrary;
import nlp.library.DicLibrary;
import nlp.splitWord.impl.GetWordsImpl;
import nlp.util.AnsjReader;
import nlp.util.Graph;
import nlp.util.MyStaticValue;
