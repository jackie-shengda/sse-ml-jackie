...
public class issueModelTest {
    private static int VOCAB_SIZE = 12000;
    private static int maxCorpusLength = 128;  //最大语料长度
    private static int numLabel = 5;           //标签个数
    ...
    public static void main(String args[]) throws Exception {
        ...
        File modelPath = new File("./src/main/java/resources/issue/issueModel.zip");
        ...
        //语料标签
        JavaRDD<String> javaRDDLabel = jsc.textFile("./src/main/java/resources/issue/labels.txt");
